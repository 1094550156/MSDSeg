...
from msdseg_net_ablation.blocks import *
from msdseg_net_ablation.topblock import *
from msdseg_net_ablation.blocks1 import *
...
class PPContextModule(nn.Module):
    ...
    Args:
        in_channels (int): The number of input channels to pyramid pooling module.输入通道数到金字塔池模块
        inter_channels (int): The number of inter channels to pyramid pooling module.金字塔池模块的通道间数量
        out_channels (int): The number of output channels after pyramid pooling module.金字塔池化模块后的输出通道数
