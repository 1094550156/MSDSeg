...
class MSDSeg(nn.Module):
    ...
    def __init__(self, num_classes=19, dilations0=[1,1,1],dilations1=[1,4,8],
                 pretrained=True, change_num_classes=False):
        super(MSDSeg, self).__init__()
        self.stem = StemBlock(out_chan=32)
        self.stage8 = nn.Sequential(
            mod_Inception_block(32, 64, dilation=dilations0, branch_planes=16, stride=2),
            mod_Inception_block(64, 64, dilation=dilations0, branch_planes=32),
            mod_Inception_block(64, 64, dilation=dilations0, branch_planes=32),
            mod_Inception_block(64, 64, dilation=dilations0, branch_planes=32),
            mod_Inception_block(64, 64, dilation=dilations0, branch_planes=32),
            mod_Inception_block(64, 64, dilation=dilations0, branch_planes=32),
        ...
        self.stage16 = nn.Sequential(
            mod_Inception_block(64, 128, dilation=dilations1, branch_planes=32, stride=2),
            mod_Inception_block(128, 128, dilation=dilations1, branch_planes=64),
            mod_Inception_block(128, 128, dilation=dilations1, branch_planes=64),
            mod_Inception_block(128, 128, dilation=dilations1, branch_planes=64),
            mod_Inception_block(128, 128, dilation=dilations1, branch_planes=64),
            mod_Inception_block(128, 128, dilation=dilations1, branch_planes=64),
