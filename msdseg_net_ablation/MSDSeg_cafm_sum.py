...
class Exp2_Decoder12(nn.Module):
    def __init__(self, num_classes, channels4, channels8, channels16):
        super().__init__()
...
class MSDSeg(nn.Module):
    ...
    def __init__(self, num_classes=19,
        ...
        self.Exp2_Decoder12 = Exp2_Decoder12(num_classes, 32, 64, 128)
    ...
    def forward(self, m):
        ...
        out = F.interpolate(self.Exp2_Decoder12(x4, x8, x16), size=m.shape[-2:], mode='bilinear', align_corners=False)
        return out
