...
from benchmark import compute_time_no_loader,compute_loader_time
...
def save_cityscapes_results(config,pred_dir):
    from utils.evaluator import save_results
...
def validate_main():
    ...
    config["pretrained_path"]="checkpoints/sgsd_net_all_run1"
    confmat=validate_one(config)
    return confmat
def train_main():
...
def save_results_main():
    ...
    config["pretrained_path"]="checkpoints/1000epochs_Zdence_mult_ohem1_run1"
