...
# from xiaorong.sgsd_net_backbone_resnet18 import SGSD_Net
...
def get_model(config):
    ...
    if model_type == "experimental2" or model_type == "regseg" or model_type == "stdcnet" or model_type == "sgsdnet":
        ...
        # return FBSNet(classes=19)
        # return ERFNet(classes=19)
